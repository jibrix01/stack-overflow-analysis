...
The raw data comes from the 2024 Stack Overflow Developer Survey. It covers 165,437 respondents across 185 countries. The dataset is released under the Open Database License.

**Note:** The dataset itself is not included in this repository; it exceeded file size limits.
...
Strict cleaning steps were applied before running any analysis. The final dataset dropped to 19,990 professional developers with valid pay and experience data.
...
The notebook opens with an exploratory data analysis section (dataset shape, missing values, distributions of pay, experience, country, and remote status) before moving into the pay and satisfaction questions below.
...
* A five-fold cross-validated Random Forest edges out a plain Ridge regression by about two points of R² (0.56 vs. 0.54), though even the better model is off by about 50% on a typical prediction.
